...
export const TEMAS_SEMANA: TemaSemana[] = [
...

  {
    ...
    patron: { jp: "___ から、にほんご を べんきょう しています。", es: "Estudio japonés porque ___." },
    nota: "「から」significa «porque». La razón va antes.",
    ejemplo: { jp: "アニメ が すき だから、にほんご を べんきょう しています。", es: "Estudio japonés porque me gusta el anime." },
    extensiones: [
      { jp: "むずかしい です が、たのしい です！", es: "Es difícil, ¡pero divertido!" },
    ...
    plantilla: {
      estructura: "{{REASON}} から、にほんご を べんきょう しています。",
      ...
      desglose: [{txt:"{{REASON}}",t:"pred",es:"razón"},{txt:"から",t:"part",es:"porque"},{txt:"にほんご を べんきょう しています",t:"pred",es:"estudio japonés"}],
    },
  },
...

  {
    id: 25,
    kana: "わたし が できること",
    prompt: "¿Qué sabes hacer? Cuéntanos.",
    meta: "Aprende a decir lo que puedes hacer con 「できます」.",
    patron: { jp: "わたし は ___ が できます。", es: "Yo sé / puedo ___." },
    nota: "「できます」significa «sé hacer» o «puedo». La habilidad va después de 「が」.",
    ejemplo: { jp: "わたし は ギター が できます！", es: "¡Yo sé tocar la guitarra!" },
    extensiones: [
      { jp: "でも、〇〇 は まだ できません。", es: "Pero 〇〇 todavía no puedo." },
      { jp: "れんしゅう すれば、できます よ！", es: "¡Con práctica se puede!" },
      { jp: "あなた は なに が できます か？", es: "¿Y tú, qué sabes hacer?" },
    ],
    fotoSugerencia: "¡Foto o video de esa habilidad tuya!",
    plantilla: {
      estructura: "わたし は {{SKILL}} が できます。",
      estructuraEs: "Yo sé / puedo {{SKILL}}.",
      slots: [{ id: "SKILL", etiqueta: "habilidad", opciones: [
        { jp: "りょうり", es: "cocinar" },
        { jp: "ギター", es: "tocar la guitarra" },
        { jp: "えをかくこと", es: "dibujar" },
        { jp: "スペイン語", es: "hablar español" },
        { jp: "およぐこと", es: "nadar" },
        { jp: "ゲーム", es: "jugar videojuegos" },
        { jp: "ダンス", es: "bailar" },
        { jp: "しゃしんをとること", es: "tomar fotos" },
        { jp: "うたうこと", es: "cantar" },
        { jp: "うんてん", es: "manejar" },
      ] }],
      desglose: [
