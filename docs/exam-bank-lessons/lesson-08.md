...
- choices: ["lluvia","soleado","clima","nieve"]
- correct: "soleado"
...
- choices: ["nieve","lluvia","soleado","pronóstico del tiempo"]
...
- choices: ["temperatura (clima)","nieve","lluvia","soleado"]
...
- choices: ["雨 (あめ)","晴れ (はれ)","バーベキュー","雪 (ゆき)"]
- correct: "バーベキュー"
