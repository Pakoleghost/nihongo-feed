...
function WriteContent() {
  ...
  // Estados de Maestro (Versión Actualizada)
    ...
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "20px", fontFamily: "sans-serif" }}>
      ...
      {isAdmin && !assignmentId && (
        <div style={{ backgroundColor: "#f0fdf4", padding: "20px", borderRadius: "12px", marginBottom: "30px", border: "1px solid #dcfce7" }}>
          <h3 style={{ margin: "0 0 15px 0", fontSize: "14px", color: "#166534" }}>CONFIGURACIÓN DE SENSEI</h3>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "15px" }}>
            ...
            {postType !== 'post' && (
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: "12px", color: "#666" }}>Grupo</label>
                <select value={targetGroup} onChange={(e) => setTargetGroup(e.target.value)} style={{ width: "100%", padding: "8px", borderRadius: "6px", border: "1px solid #ccc" }}>
                  <option value="">¿A quién va dirigido?</option>
            ...
            {postType === 'assignment' && (
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: "12px", color: "#666" }}>Lugar entrega</label>
                <select value={assignmentSubtype} onChange={(e) => setAssignmentSubtype(e.target.value as any)} style={{ width: "100%", padding: "8px", borderRadius: "6px", border: "1px solid #ccc" }}>
                  <option value="internal">Blog (App)</option>
                  <option value="external">Externo (Libro)</option>
                </select>
              </div>
            )}
          </div>
