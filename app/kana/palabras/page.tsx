      ...
      >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, marginBottom: 16 }}>
          {[
            ...
            <div key={s.label} style={{ background: "#1E2235", borderRadius: 16, padding: "14px 10px", textAlign: "center", border: "1px solid rgba(255,255,255,0.07)" }}>
        ...
        {missedItems.length > 0 && (
          <div style={{ background: "#1E2235", borderRadius: 16, padding: "16px", marginBottom: 20, border: "1px solid rgba(255,255,255,0.07)" }}>
