    ...
    <>
      ...
      <div className="post" style={{ marginTop: 12 }}>
        <div className="post-header">
          ...
          >
            {myAvatarUrl ? (
              <img src={myAvatarUrl} alt={myUsername || "me"} />
            ) : (
          ...
          <div className="postMeta">
            <div className="nameRow">
              <Link href={myProfileHref} className="handle" style={linkStyle}>
                @{myUsername || "unknown"}
              </Link>
              ...
              <button
                ...
                title="Edit bio"
              >
                {editingBio ? "Cancel" : "Bio"}
              </button>

              <button className="ghostBtn" type="button" onClick={logout} title="Log out">
                Exit
              </button>
            </div>

            <div className="muted" style={{ marginTop: 6 }}>
              {myBio ? myBio : "No bio yet."}
            </div>
          </div>
        </div>
        ...
        {editingBio ? (
          <div style={{ padding: "0 12px 12px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 8 }}>
              ...
              <button className="postBtn" type="button" onClick={saveMyBio} disabled={bioBusy}>
                {bioBusy ? "Saving…" : "Save"}
              </button>
            </div>
          </div>
